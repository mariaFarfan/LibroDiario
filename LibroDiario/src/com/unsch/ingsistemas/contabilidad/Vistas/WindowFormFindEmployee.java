...
public class WindowFormFindEmployee extends javax.swing.JFrame {
    ...
    public void llenarTabla() {
        ...
        String s = "select nombre, cargo from empleado;";
...
//            }
    ...
    public void filtro() {
        int columnaB = 0;
        if (jComboBox1.getSelectedItem() == "CARGO") {
            columnaB = 1;
            System.out.println(" -- ");
        }
...
//                modelo.addRow(registro);
    ...
    /**
     * Creates new form WindowFormFindEmployee
     */
    public WindowFormFindEmployee() {
        initComponents();
        llenarTabla();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NOMBRE", "CARGO" }));
    ...
    private void jtbCuentasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbCuentasMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            WindowFormPlanilla.txtNombre.setText(cuenta);
            WindowFormPlanilla.txtCargo.setText(descripcion);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowFormFindEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowFormFindEmployee().setVisible(true);
            }
        });
    }
