 ...
 */
public class WindowFormFind3 extends javax.swing.JFrame {
...
//            WindowFormAsiento.jtfCuenta.setText(cuenta);
            WindowFormInventario.jtfDescripcion1.setText(descripcion);
//            llenarGrupo(cuenta);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowFormFind3.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowFormFind3().setVisible(true);
            }
        });
    }
